...
describe("canvasReducer", () => {
	...
	it("should handle SELECT_SHAPE action", () => {
		...
		const newState = canvasReducer(state, action as CanvasActionUnion);
	...
	it("should handle RESET action", () => {
		...
		const stateAfterReset = canvasReducer(
